...
import { Users, ArrowLeft, Copy, CheckCircle2, ExternalLink, Shield } from 'lucide-react';
                    ...
                    {signers && signers.length > 0 && (
                      <div className={`mt-6 p-4 rounded-lg border ${
                        ...
                        <p className={`text-sm ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'}`}>
                          <strong>Note:</strong> Signers are managed through multisig transactions. 
                          To add or remove signers, you'll need to submit a transaction that requires {threshold} signatures for approval.
                        </p>
                      </div>
                    )}
                  </CardContent>
